...
// ** Icons Imports
import { Slack, User, MoreVertical, FileText, Trash2, Edit, Feather, Edit3, Briefcase } from 'react-feather'
            ...
            <DropdownMenu>
              ...
              <Modal isOpen={centeredModal} toggle={() => setCenteredModal(!centeredModal)} className='modal-dialog-centered'>
                ...
                <ModalFooter className='m-auto'>
                  <Button color='primary' onClick={() => deleteUser(row.id)}>
                    بله
                  </Button>
                  <Button color='secondary' onClick={() => setCenteredModal(false)}>
                    خیر
                  </Button>
                </ModalFooter>
              </Modal>
