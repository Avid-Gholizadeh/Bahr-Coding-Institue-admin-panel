...
const UserDropdown = ({profileData,profileLoading}) => {
  ...
  return (
    <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
      {profileLoading? <Spinner type="grow" size='md' color="primary"/>:<>
      <DropdownToggle
        href="/"
        tag="a"
      ...
      >
        <div className="user-nav d-sm-flex d-none">
          <span className="user-name fw-bold"> {profileData?.fName} {' '} {profileData?.lName} </span>
      ...
      <DropdownMenu end>
        ...
        <DropdownItem tag="a" href="http://localhost:5173" target="_blank" rel="noopener noreferrer">
